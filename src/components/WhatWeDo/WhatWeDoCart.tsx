...
const WhatWeDoCart = () => {
  return (
    <div className=" flex flex-wrap justify-center items-center gap-4 my-14">
      {/* Card 1 */}
      <div className="w-[640px] h-[400px]  hover:bg-[#1f236f] transition-all duration-500  lg:flex md:flex sm:flex-row sm:flex  text-white m-0 overflow-hidden relative group shadow-[0px_0px_11px_-4px_rgb(102,102,112)] hover:text-white sx:flex-col-reverse sx:flex ">
        {/* Text Section */}
        <div className="flex-1 md:px-10 lg:px-10 md:py-12 lg:py-12 lg:w-[50%] md:w-[50%] text-black hover:text-white  sx:p-4   ">
          <h2 className=" lg:text-3xl md:text-3xl sm:text-3xl  font-bold mb-4 sx:text-xl   ">
            Tailored Cleaning Solutions
          </h2>
          <p className=" lg:my-10 md:my-10 sm:my-8 lg:text-xl md:text-xl sm:text-xl sx:my-2 sx:text-sm">
        ...
        <div className=" lg:flex md:flex sm:flex lg:justify-end md:justify-end sm:justify-end lg:mt-28 md:mt-28 sm:mt-28  relative lg:flex-1 mg:flex-1 sm:flex-1 lg:w-[50%] md:w-[50%] sm:w-[50%] sx:mt-0 ">
          {/* Icon */}
          <div className="absolute -top-1 left-24 text-red-500 bg-white p-4 rounded-full transition-transform duration-500 group-hover:rotate-[360deg] z-40 lg:block md:block  sm:block sx:hidden ">
      ...
      {/* Card 2 */}
      <div className="w-[640px] h-[400px]  hover:bg-[#1f236f] transition-all duration-500  lg:flex md:flex sm:flex text-white m-0 overflow-hidden relative group shadow-[0px_0px_11px_-4px_rgb(102,102,112)] hover:text-white ">
        {/* Image and Icon Section */}
        <div className="lg:flex md:flex sm:flex lg:justify-end md:justify-end sm:justify-end lg:mt-28 md:mt-28 sm:mt-28  relative lg:flex-1 mg:flex-1 sm:flex-1 lg:w-[50%] md:w-[50%] sm:w-[50%]  sx:mt-0 ">
          {/* Icon */}
          <div className="absolute -top-1 left-24 text-red-500 bg-white p-4 rounded-full transition-transform duration-500 group-hover:rotate-[360deg] z-40 lg:block md:block  sm:block sx:hidden">
      ...
      <div className="w-[640px] h-[400px]  hover:bg-[#1f236f] transition-all duration-500  lg:flex md:flex sm:flex-row sm:flex  text-white m-0 overflow-hidden relative group shadow-[0px_0px_11px_-4px_rgb(102,102,112)] hover:text-white sx:flex-col-reverse sx:flex">
        ...
        <div className="lg:flex md:flex sm:flex lg:justify-end md:justify-end sm:justify-end lg:mb-28 md:mb-28 sm:mb-28  relative lg:flex-1 mg:flex-1 sm:flex-1 lg:w-[50%] md:w-[50%] sm:w-[50%]  sx:mt-0 ">
          {/* Icon */}
          <div className="absolute  bottom-10 left-16 text-red-500 bg-white p-4 rounded-full transition-transform duration-500 group-hover:rotate-[360deg] z-40 lg:block md:block  sm:block sx:hidden">
      ...
      {/* Card 4 */}
      <div className="w-[640px] h-[400px]  hover:bg-[#1f236f] transition-all duration-500  lg:flex md:flex sm:flex-row sm:flex  text-white m-0 overflow-hidden relative group shadow-[0px_0px_11px_-4px_rgb(102,102,112)] hover:text-white  ">
        {/* Image and Icon Section */}
        <div className="lg:flex md:flex sm:flex lg:justify-end md:justify-end sm:justify-end lg:mb-28 md:mb-28 sm:mb-28  relative lg:flex-1 mg:flex-1 sm:flex-1 lg:w-[50%] md:w-[50%] sm:w-[50%]  sx:mt-0 ">
          {/* Icon */}
          <div className="absolute bottom-10 right-16 text-red-500 bg-white p-4 rounded-full transition-transform duration-500 group-hover:rotate-[360deg] z-40 lg:block md:block  sm:block sx:hidden">
