...
const ServiceBanner = () => {
  return (
    <>
      <div className=" bg-gradient-to-b from-[#E63710] to-[#ee6749]  lg:h-[350px] md:h-[350px] sm:h-[350px] sx:h-[480px] mt-20  text-center">
        <h2 className=" text-[#32297C] text-4xl text-center pt-16 ">
          Services
        </h2>
        <h3 className="py-2 px-4 rounded-full bg-[#32297C] text-white my-4 lg:text-2xl md:text-2xl sm:text-2xl font-bold lg:w-[450px] md:w-[450px] sm:w-[450px] sx:w-[320px] sx:text-base mx-auto ">
          Cleaning Solutions for Every Need
        </h3>
        <p className="text-white lg:w-[620px] md:w-[620px] sm:w-[520px] sx:w-[320px] mx-auto text-lg">
          Welcome to our versatile cleaning services! AUCS handle offices,
          commercial buildings, residential complexes, mixed developments, malls
          and more. Our comprehensive approach covers interior and exterior
          maintenance, including specialized services like floor scrubbing,
          buffing and water jetting. Trust us to keep your spaces clean and
